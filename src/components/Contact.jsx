...
const Contact = ({ openEndpoint, setOpenEndpoint }) => {
  const endpoints = useMemo(() => contactEndpoints, []);
    ...
    <div className="api-docs">
      <div className="search-container">
        <input
          ...
          placeholder="Tìm kiếm endpoint liên hệ..."
          value={searchTerm}
      ...
      {filteredEndpoints.length > 0 ? (
        ...
        <p>Không tìm thấy endpoint liên hệ phù hợp.</p>
      )}
    </div>
  );
};
